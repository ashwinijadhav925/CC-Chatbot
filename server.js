...
var rep4="<a href=\"https://docs.google.com/document/d/1fCdmvD2oaQ-9gxW8LN4SYazK_rfx2ylX_g3-4V7ujtc/edit\" target=\"_blank\">click here</a>";
var rep5="<a href=\"https://docs.google.com/document/d/1hvUpHJH5L8UTyets-gw8XYZ-gIv2jzofM3I6Uy7HuO8/edit\" target=\"_blank\">click here</a>";
var wrongChoice="";
...
function chatbotReply(data){
   ...
   switch(data.message) {
        ...
        case '3':
            ...
            break;
        case '4':
            botreply.message=rep4;
          break;
        case '5':
            botreply.message=rep5;
          break;
        case '*':
            botreply.message=menu[1];
          break;
        default:
            botreply.message="Please enter a valid number!";
      }
